 ...
 */
public class FormaTitular extends javax.swing.JDialog {
    ...
    private final FormaPrincipal fp;
     ...
     */
    public FormaTitular(java.awt.Frame parent, boolean modal, Integer tipoLLamada, Integer indiceElementoModificar) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormaTitular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FormaTitular dialog = new FormaTitular(new javax.swing.JFrame(), true, null, null);
