 ...
 */
public class FormaAnejo extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FormaAnejo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormaAnejo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormaAnejo dialog = new FormaAnejo(new javax.swing.JFrame(), true);
