...
public class FormaProcesarTasacion extends javax.swing.JDialog {
    ...
    private void limpiarComponentes(){
        ...
        //Combo
        eFinalidadTasacion.setSelectedIndex(0); 
        eFuenteDatos.setSelectedIndex(0); 
        eLeyMercado.setSelectedIndex(0); 
        eMetodoValoracion.setSelectedIndex(0); 
        ...
        switch(TipoCombo){
            ...
            /*case "Advertencias":
                 ...
                 /*case "Condicionantes":
                                ...
                                break; */
            case "Finalidad":modelFinalidad = new Vector();
                                ...
                                break;
            case "Fuente":modelFuente = new Vector();
                                ...
                                break;
            case "Ley mercado":modelLeyMercado = new Vector();
                                ...
                                break; 
            case "Método valoración":modelMetodoValoracion = new Vector();
                                ...
                                break;
            case "Método valoración estadístico":modelMetodoValoracionEstadistico = new Vector();
                                ...
                                break;
            case "Visita inmueble":modelVisitaInmueble = new Vector();
    ...
    private void initComponents() {
        ...
        eAdvertencias = new javax.swing.JList<>();
        ...
        eCondicionantes = new javax.swing.JList<>();
        jLabel16 = new javax.swing.JLabel();
        eEmpresaTasadora = new javax.swing.JTextField();
        ...
        eFinalidadTasacion = new javax.swing.JComboBox<>();
        jLabel40 = new javax.swing.JLabel();
        eFuenteDatos = new javax.swing.JComboBox<>();
        jLabel41 = new javax.swing.JLabel();
        eLeyMercado = new javax.swing.JComboBox<>();
        jLabel42 = new javax.swing.JLabel();
        eMetodoValoracion = new javax.swing.JComboBox<>();
        jLabel43 = new javax.swing.JLabel();
        eMetodoValoracionEstadistico = new javax.swing.JComboBox<>();
        jLabel44 = new javax.swing.JLabel();
        eVisitaInmueble = new javax.swing.JComboBox<>();
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(eEmpresaTasadora, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MousePressed
        if (eAdvertencias.getSelectedIndex() != -1){
            listaAvertencias.removeElementAt(eAdvertencias.getSelectedIndex());
            eAdvertencias.setModel(listaAvertencias);
        }else{
    ...
    private void jButton4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MousePressed
        if (eCondicionantes.getSelectedIndex() != -1){
            listaCondicionantes.removeElementAt(eCondicionantes.getSelectedIndex());
            eCondicionantes.setModel(listaCondicionantes);
        }else{
    ...
    private javax.swing.JTextField eEmpresaTasadora;
