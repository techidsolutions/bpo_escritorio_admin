...
public class Finca {
    ...
    public Finca(ArrayList<ComponenteFormulario> listaComponentesXML, ArrayList<ArrayList<ComponenteFormulario>> listaTitulares, ArrayList<ArrayList<ComponenteFormulario>> listaAnejos) {
